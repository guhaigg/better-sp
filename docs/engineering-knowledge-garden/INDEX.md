...
3. **Hand off** only the short guidance brief into brainstorming / planning
4. **Do the real work**
5. **Distill** only proven reusable lessons into evergreen entries
6. **Validate / audit / prune** with `gardener-mode`
